...
err_bits = 4;                % This is the number of erroneous bits
beta0 = 100;                   % beta determines the degree of stochasticness of the Hopfield network
...
%         end
        ...
        while (exit_flag == 0)                                        
            ...
            if (convergence_flag == 0)      %If 0, do max_itr iterations and quite
                ...
                if (((norm(x-x_last_last) == 0)&&(mod(itr,2)==0))|(itr > 1000))
                    exit_flag = 1;                    
                end
            end
