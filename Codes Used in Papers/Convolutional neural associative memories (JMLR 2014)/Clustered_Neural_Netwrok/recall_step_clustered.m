...
function [x_out] = recall_step_clustered(W,x,N,gamma_BFO,gamma_BFS,max_noise_amp,err_bits,y_min,y_max,recall_algorithm_option)
...
while (exit_flag == 0)
    ...
    for iii = 1:N_const                
        if (abs(c_temp_WTA(iii))<.005)                        % Take care of numerical issues                        
            c_temp_WTA(iii) = 0;                                
        end        
        
        if (abs(c_temp_BFO(iii))<.005)                        % Take care of numerical issues                        
            c_temp_BFO(iii) = 0;                                
        end        
        
        if (abs(c_temp_BFS(iii))<.005)                        % Take care of numerical issues                        
            c_temp_BFS(iii) = 0;                                
        end        
    end
