...
max_noise_amp = 1;
no_of_patterns = 400;
no_of_simulated_instances = 5000;
...
for l =1:index_max                                % For all simulation scenarios do...
    ...
    for itr = 1:ceil(no_of_simulated_instances/simul_instances_per_job)   % Simulate the error correction procedure for the given ensemble.
        ...
        command = ['cd /scratch/amir/ITW_Journal/Submit_Cluster;qsub -N "Lee_neur_N_',num2str(N),...
                ...
                ',random_flag=',num2str(random_flag),' lee_neural_recall.pbs'];                                            
