...
saved_deg_dist_file = ['scratch/amir/Fault_Tolerant_Decoding/Learn_Results/N_',num2str(N),'_K_',num2str(K),'_L_',num2str(L),'/Network_Properties/Deg_dist_global_alpha0_',num2str(alpha0),'_beta0_',num2str(beta0),'_theta0_',num2str(theta0),'.mat'];

if (~exist(['scratch/amir/Fault_Tolerant_Decoding/Learn_Results/N_',num2str(N),'_K_',num2str(K),'_L_',num2str(L),'/Network_Properties'],'dir'))
    mkdir(['scratch/amir/Fault_Tolerant_Decoding/Learn_Results/N_',num2str(N),'_K_',num2str(K),'_L_',num2str(L),'/Network_Properties'])
end

if (exist(saved_deg_dist_file,'file'))
    load(saved_deg_dist_file)
    return
end    
...
save(saved_deg_dist_file,'lambda','rho','deg_row','deg_column');
%==========================================================================
