...
function clustered_neural_initialization_v2(N,K,L,deg_cluster_min,index_max)
...
mkdir(['/scratch/amir/Clustered_Neural/Initialization_Files'],['N_',num2str(N),'_K_',num2str(K),'_L_',num2str(L)]);        % Create a specific folder for the current N and K
...
for index = 1:index_max
    ...
    for l = 1:L
        ...
        save(['/scratch/amir/Clustered_Neural/Initialization_Files/N_',num2str(N),'_K_',num2str(K),'_L_',num2str(L),'/clustered_neural_parameters_v1_N_',num2str(N),'_K_',num2str(K),'_L_',num2str(L),'_index_',num2str(index),'_cluster_',num2str(l),'.mat'],'index_l');
        %------------------------------------------------------------------
    ...
    clear temp
    clear index_l 
    save(['/scratch/amir/Clustered_Neural/Initialization_Files/N_',num2str(N),'_K_',num2str(K),'_L_',num2str(L),'/clustered_neural_parameters_v1_N_',num2str(N),'_K_',num2str(K),'_L_',num2str(L),'_index_',num2str(index),'.mat']);                    % Store all the variables in the appropriate file. 
    %----------------------------------------------------------------------
