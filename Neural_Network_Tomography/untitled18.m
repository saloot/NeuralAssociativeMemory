% function BP_rule_leaky_inhibitory(n_exc,n_inh,T,tau,theta,p,q,no_averaging_itrs,B_LLR_thr,B_LLR_flag,mode)
...
if (B_LLR_flag)
    fid = fopen(['Simulation_Results/Belief_LLR_leaky_inhib_n_',num2str(n_exc),'_',num2str(n_inh),'_no_averaging_itrs_',num2str(no_averaging_itrs),'_mode_',num2str(mode),'.txt'], 'a+');        
else
    fid = fopen(['Simulation_Results/Belief_LLR_leaky_inhib_Delta_1_n_',num2str(n_exc),'_',num2str(n_inh),'_no_averaging_itrs_',num2str(no_averaging_itrs),'_mode_',num2str(mode),'.txt'], 'a+');        
end
