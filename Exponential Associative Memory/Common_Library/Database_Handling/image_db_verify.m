...
function success_index = image_db_verify(file_name_base,L_horiz,L_vert)
...
for index_horiz = 1:L_horiz
    for index_vert = 1:L_vert    
        file_name = [file_name_base,num2str(index_horiz),'_',num2str(index_vert),'.mat'];        
