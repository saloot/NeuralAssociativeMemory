...
initialization_done_by_main = 1;        % Tells the other codes that the initialization has been done before
%--------------------------------------------------------------------------
...
addpath(genpath('./Other_Works'));                                   % Include the library of common functions in the search path% Include the library of common functions in the search path
%--------------------------------------------------------------------------

%--------------------------Set Learn Results Paths-------------------------
...
if (real_dataset_flag == 0)
    ...
    fid = fopen([db_file_folder,'/Preprocessed/','Preprocessed_',db_file_name], 'r');                        % The path towards the dataset
    if (fid < 0)
        initialize_flag = 0;
        break
    else
